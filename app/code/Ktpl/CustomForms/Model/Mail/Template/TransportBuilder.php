...
namespace Ktpl\CustomForms\Model\Mail\Template;
...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    public function addFormAttachment($filesUpload)
    {   
        foreach($filesUpload as $key => $value){
            if($this->file->fileExists($value['path'])){
                $attachmentPart = $this->partFactory->create();
                $attachmentPart->setContent($this->file->read($value['path']))
                ->setType(mime_content_type($value['path']))
