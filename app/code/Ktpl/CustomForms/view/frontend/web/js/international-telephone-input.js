...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('input[name=phone]').addEventListener('keyup', function(event) {

        var object = {};
        var value = document.getElementById("phonenumber").value;
        var name = document.getElementById("phonenumber").name;
        ...
        if(isValidNumber.valid) {
            phoneLabel.style.cssText = "color: blue;";
            ...
            phoneLabel.style.cssText = "color: red;";
            document.querySelector('form').style.cssText = "position: relative; left: 16%;";
            phoneLabel.innerText = "Please insert a valid phone number";
