...
namespace Magebit\AheadworksCtq\Rewrite\Aheadworks\Ctq\Block\Html;

use Aheadworks\Ctq\Block\Html\Pager as PagerParent;
use Magento\Framework\Api\SearchResultsInterface;

/**
 * We are overriding default Aheadworks pager just to change the template.
 */
class Pager extends PagerParent
{
    /**
