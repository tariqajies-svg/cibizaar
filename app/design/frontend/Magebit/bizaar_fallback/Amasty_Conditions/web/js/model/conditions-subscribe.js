define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            // TI-432 avoid request call on multiple address clicks
            const recollectAfterShippingRates =  _.debounce((newShippingAddress) => {
            ...
            quote.shippingAddress.subscribe(function (newShippingAddress) {
                ...
                recollectAfterShippingRates(newShippingAddress);
            }.bind(this));
